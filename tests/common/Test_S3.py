...
class TestS3BucketConnectorMethods(unittest.TestCase):
    """
    Tetsing the S3BucketConnector Class
    """
    ...
    def test_write_df_to_s3_empty(self):
        """
         Tests the write_df_to_s3 metod with
        ...
        with self.assertLogs() as logm:
            ...
            # Log test after method eecution
            self.assertIn(log_exp,logm.output[0])
            #test after method execution
    ...
    def test_write_df_to_s3_csv(self):
        ...
        #Expected results
        return_exp = True
        df_exp = pd.DataFrame([['A','B'],['1','2']], columns = ['col1','col2'])
        key_exp = 'test.csv'
    ...
    def test_write_df_to_s3_format(self):
        """
        Tests the write_df_to_s3 method
        if unsupported format is given as argument
        """
