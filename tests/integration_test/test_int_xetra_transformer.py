...
class IntTestXetraETLMethods(unittest.TestCase):
    """
    Integration testing the xetra ETL class
    """
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'xetra-int-test-src-rn23'
        self.s3_bucket_name_trg = 'xetra-int-test-trg-rn23'
    ...
    def test_etl_report1_no_metafile(self):
        """
